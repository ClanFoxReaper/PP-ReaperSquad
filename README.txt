...
- ReaperSquadConfig.cs: Example of ModConfig for custom mod settings;
- ReaperSquadGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- ReaperSquadMain.cs: Main mod class, recieves mod management and general events;
- ReaperSquadTactical.cs: Example of ModTactical for modifying tactical level;
