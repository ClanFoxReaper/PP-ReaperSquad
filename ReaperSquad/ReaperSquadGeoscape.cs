...
namespace ReaperSquad
{
	...
	public class ReaperSquadGSInstanceData
	{
	...
	/// </summary>
	public class ReaperSquadGeoscape : ModGeoscape
	{
		/// <summary>
		...
		public override object RecordGeoscapeInstanceData() {
			return new ReaperSquadGSInstanceData() { ExampleData = 5 };
		}
		/// <summary>
		...
		public override void ProcessGeoscapeInstanceData(object instanceData) {
			ReaperSquadGSInstanceData data = (ReaperSquadGSInstanceData)instanceData;
		}
