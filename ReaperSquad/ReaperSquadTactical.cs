...
namespace ReaperSquad
{
	...
	public class ReaperSquadTacInstanceData
	{
	...
	/// </summary>
	public class ReaperSquadTactical : ModTactical
	{
		/// <summary>
		...
		public override void OnTacticalStart() {
			...
			ReaperSquadMain main = (ReaperSquadMain)Main;
		}
		/// <summary>
		...
		public override void ProcessTacticalInstanceData(object instanceData) {
			ReaperSquadTacInstanceData data = (ReaperSquadTacInstanceData)instanceData;
		}
		/// <summary>
		...
		public override object RecordTacticalInstanceData() {
			 return new ReaperSquadTacInstanceData() { ExampleData = 5 };
		}
		/// <summary>
